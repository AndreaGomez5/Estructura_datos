...
if __name__ == "__main__":
    empleado = Empleado("Juan", 50000, "Ventas")
    print(empleado.trabajar())

    gerente = Gerente("Ana", 70000, "TI", ["Luis", "Marta"])
    print(gerente.trabajar())
    print(gerente.supervisarAEquipo())

    desarrollador = Desarrollador("Carlos", 60000, "Desarrollo", "Python")
    ...
    admin = Administrador("Admin01", "adminpass")
    print(admin.iniciarSesion("Admin01", "adminpass"))
    print(admin.gestionarUsuarios())

    cliente = Cliente("Cliente01", "clientepass")
    print(cliente.iniciarSesion("Cliente01", "clientepass"))
